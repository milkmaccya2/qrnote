...
function Toast({ toast, onRemove }: ToastProps) {
  ...
  const getTypeStyles = () => {
    switch (type) {
      case 'success':
        return 'border-green-500/50 bg-green-900/20 text-green-200';
      case 'error':
      ...
      default:
        return 'border-gray-500/50 bg-gray-900/20 text-gray-200';
    }
  };
  ...
  return (
    <div className={`
      flex items-start gap-3 p-4 rounded-2xl border backdrop-blur-xl shadow-lg
